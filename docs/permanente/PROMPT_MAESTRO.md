...
3. CONSOLIDACIÓN MULTI-MONEDA A BASE ARS: La moneda subyacente de la arquitectura es el Peso Argentino. En "Registros", la columna I ("Col1") guarda el monto nominal. Las columnas adyacentes Q, R, S, T guardan la cantidad de PESOS que vale 1 unidad de ARS, USD, AUD y EUR respectivamente (Nota: la columna de TC_ARS siempre será 1.0). Para consolidar transacciones cruzadas a ARS, basta con multiplicar la columna del Monto por la columna del Tipo de Cambio pertinente a esa transacción. Nada más simple.
