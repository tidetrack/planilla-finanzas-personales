...
| Mirada Interanual | Matriz conceptos x 12 meses (ventana movil) + fila de meses con nombre + grafico de tendencias | Produccion; script re-alineado en v0.68.0, fila de meses y grafico ejecutados y verificados en vivo el 2026-09-07 (ver FUNCIONALIDADES 06) |
